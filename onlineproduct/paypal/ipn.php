...
// or add other error handling. 
 ...
 //email
 $mail_From = "From: handgunnercj@yahoo.com";
 $mail_To = $email;
  ...
  while (!feof($fp)) {
    ...
    if (strcmp ($res, "VERIFIED") == 0) {
      ...
      if (($payment_status == 'Completed') &&  
         ($receiver_email == "handgunnercj@yahoo.com") &&   // receiver_email is same as your account email
...
//        uncomment this section during development to receive an email to indicate whats happened
            $mail_To = "hundgunnercj@yahoo.com";
...
// we will send an email to say that something went wrong
          $mail_To = "handgunnercj@yahoo.com";
